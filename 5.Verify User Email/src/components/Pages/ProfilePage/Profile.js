...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyDkjdM-NhsT3JN-KZnX_jIy9puQ1AUwJ5k`;
...
async function getUserProfile(idToken, ctx) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyDkjdM-NhsT3JN-KZnX_jIy9puQ1AUwJ5k`;
...
async function verifyEmail(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyDkjdM-NhsT3JN-KZnX_jIy9puQ1AUwJ5k`;
